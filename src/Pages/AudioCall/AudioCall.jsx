...
export default function AudioCall() {
    ...
    const audioSendRef = useRef()
    const audioReceiveRef = useRef()
    ...
    useEffect(() => {
        if (id) {
            ...
            socketRef.current.onclose = () => {
                console.log('ac socket closed');
            }
            socketRef.current.onopen = () => {
                console.log('ac socket opened');
            }
        }
        return () => {
    ...
    useEffect(() => {
        if (call) {
            ...
            peerConnectionRef.current.ontrack = (e) => {
                audioReceiveRef.current.srcObject = e.streams[0];
            };
            return () => {
    ...
    return (
        <Layout>
            {call &&
                <div className="video-call-container is-audio">
                    ...
                    <div className="video-container-wrapper">
                        <div className="video-container">
                            <audio autoPlay ref={audioReceiveRef} src="" className="audio-receive"></audio>
                            <audio autoPlay muted ref={audioSendRef} src="" className="audio-send"></audio>
                        </div>
